...
import net.dontdrinkandroot.lastfm.api.model.Venue;
...
public class VenueEntityParser implements EntityParser<VenueEntity> {

	@Override
	public void parse(Element element, VenueEntity entity) {

		final Element venueElement = DomUtils.getChildByTagName(element, "venue");
		if (venueElement != null) {
			entity.setVenue(new Venue(venueElement));
		}
	}
