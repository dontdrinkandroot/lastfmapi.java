...
import net.dontdrinkandroot.lastfm.api.model.parser.RecentTrackEntityParser;


@Parser(RecentTrackEntityParser.class)
public interface RecentTrackEntity extends Entity {
