...
import net.dontdrinkandroot.lastfm.api.model.parser.PlayCountEntityParser;


@Parser(PlayCountEntityParser.class)
public interface PlayCountEntity extends Entity {
