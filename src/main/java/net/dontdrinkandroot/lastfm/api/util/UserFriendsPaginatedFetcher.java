...
public class UserFriendsPaginatedFetcher implements PaginatedFetcher<List<User>> {

	private final String userName;


	public UserFriendsPaginatedFetcher(final String userName) {
	...
	public final GenericPaginatedResult<List<User>> fetchNextPage(
			...
			final PaginatedResult<List<User>> paginatedResult
