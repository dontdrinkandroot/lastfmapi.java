...
public class TracksEntityParser implements EntityParser<TracksEntity> {

	@Override
	public void parse(final Element element, final TracksEntity entity) {

		final Element tracksEl = DomUtils.getChildByTagName(element, "tracks");
		if (tracksEl != null) {
			final List<Element> trackElements = DomUtils.getChildrenByTagName(tracksEl, "track");
