...
import net.dontdrinkandroot.lastfm.api.model.parser.DurationEntityParser;
import net.dontdrinkandroot.lastfm.api.model.parser.Parser;

@Parser(DurationEntityParser.class)
public interface DurationEntity extends Entity {
