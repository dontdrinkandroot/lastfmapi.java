...
/**
 * Enfore last.fm fetch limit. "You will not make more than 5 requests per originating IP address
...
public class FetchLimitEnforcer {
	...
	private static final long MAX_REQUESTS_IN_COMPLIANCE = FetchLimitEnforcer.REQUESTS_PER_SECOND
			* DateUtils.SECONDS_PER_MINUTE * FetchLimitEnforcer.COMPLIANCE_MINUTES;
	...
	public final synchronized double getWebRequestsPerSecond() {
		...
		return (double) count / (FetchLimitEnforcer.COMPLIANCE_MINUTES * DateUtils.SECONDS_PER_MINUTE);
	}
